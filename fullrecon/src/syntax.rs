...
impl DeBruijnTerm {
    fn map_vars_walk(
        ...
        match self {
            ...
            Self::Zero => Self::zero(),
            Self::Succ(t) => Self::succ(t.map_vars_walk(cutoff, on_var)),
            Self::Pred(t) => Self::pred(t.map_vars_walk(cutoff, on_var)),
            Self::IsZero(t) => Self::is_zero(t.map_vars_walk(cutoff, on_var)),
